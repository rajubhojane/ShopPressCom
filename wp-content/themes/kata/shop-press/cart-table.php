					...
					<td colspan="6" class="actions">
						<?php if ( wc_coupons_enabled() && false === $hide_coupon_form ) { ?>
							<div class="coupon <?php echo ( $field_icon === 'yes' ) ? '' : 'no-icon'; ?>">
								...
								<input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'kata' ); ?>" /> <button type="submit" class="button" name="apply_coupon" value="<?php esc_attr_e( 'Apply', 'kata' ); ?>"><?php esc_html_e( 'Apply', 'kata' ); ?></button>
